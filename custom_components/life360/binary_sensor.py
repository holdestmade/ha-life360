...
from .const import ATTRIBUTION, DOMAIN, MANUFACTURER, SIGNAL_ACCT_STATUS
...
async def async_setup_entry(
    ...
    async_setup_member_entities(
        ...
        entry,
        async_add_entities,
        lambda mem_coordinator, mid: [
            Life360MemberBinarySensor(mem_coordinator, mid, description)
